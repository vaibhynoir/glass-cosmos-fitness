...
const TestimonialCard = ({ testimonial }: { testimonial: Testimonial }) => (
  <div className="relative rounded-2xl overflow-hidden group transition-transform duration-300 ease-in-out hover:scale-105">
    <img
      ...
      onError={(e) => {
        e.currentTarget.src = 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?auto=format&fit=crop&w=800&h=1200&q=80';
      }}
    />
    ...
    <div className="absolute top-0 left-0 p-4 text-white">
      <div className="flex items-center gap-3 mb-2">
        ...
        />
        <span className="font-semibold text-sm drop-shadow-md">{testimonial.name}</span>
      </div>
      <p className="text-sm font-medium leading-tight drop-shadow-md">{testimonial.quote.substring(0, 80)}...</p>
    </div>
  </div>
);
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      rating: 5,
      mainImage: "https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?auto=format&fit=crop&w=800&h=1200&q=80",
    },
    {
      name: "Priya Sharma",
      ...
      rating: 5,
      mainImage: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?auto=format&fit=crop&w=800&h=1000&q=80",
    },
    {
      name: "Arjun Mehta",
      role: "Tech Lead",
      ...
      rating: 5,
      mainImage: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=800&h=1200&q=80",
    },
    {
      name: "Sneha Patel",
      role: "Data Scientist",
      ...
      rating: 5,
      mainImage: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?auto=format&fit=crop&w=800&h=1000&q=80",
    },
    {
      name: "Vikram Singh",
      ...
      rating: 5,
      mainImage: "https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?auto=format&fit=crop&w=800&h=1200&q=80",
    },
    {
      name: "Ananya Reddy",
      role: "UX Designer",
      ...
      rating: 5,
      mainImage: "https://images.unsplash.com/photo-1518611012118-696072aa579a?auto=format&fit=crop&w=800&h=1000&q=80",
    },
    {
      name: "Karthik Iyer",
      ...
      rating: 5,
      mainImage: "https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?auto=format&fit=crop&w=800&h=1200&q=80",
    },
    {
      name: "Meera Nair",
      ...
      rating: 5,
      mainImage: "https://images.unsplash.com/photo-1594381898411-846e7d193883?auto=format&fit=crop&w=800&h=1000&q=80",
    },
  ];
